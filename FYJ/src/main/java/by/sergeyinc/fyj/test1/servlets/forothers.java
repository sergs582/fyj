...
public class forothers {

	public void newpagee( HttpServletRequest request, Model model) {
		...
		List <tasks> list = dt.getAllByRequest("FROM tasks where id_category>'10' and status ='1'");
	...
	public  void nextpagee( HttpServletRequest request, Model model) {
...
public  void prevpagee( HttpServletRequest request, Model model) {
