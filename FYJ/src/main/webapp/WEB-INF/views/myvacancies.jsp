...
<title>Мои вакансии||FindYourJob.by</title>
</head>
<body>
 ...
 <div class= "welcome">
         ...
         <div class= "layer">
    <h1 style="text-align:center; color: #b9f747">Мои вакансии</h1>
          <div class = "tablic" >
          
          <c:set var = "deleter" scope = "session" value = "${delete0}"/>
      <c:if test = "${deleter>0}">
         
          
          <form action="delete">
           <input type="hidden" name="id" value="<c:out value="${id0}"></c:out>">
           <input style="float: right; margin-top:10px; margin-right:10px;" width="20px" height="20px"type="image" name="butt" value="submit" alt="submit Button" src="resources/images/delete.png">
    ...
    <c:set var = "deleter" scope = "session" value = "${delete1}"/>
      <c:if test = "${deleter>0}">
         
          
          <form action="delete">
           <input type="hidden" name="id" value="<c:out value="${id1}"></c:out>">
           <input style="float: right; margin-top:10px; margin-right:10px;" width="20px" height="20px"type="image" name="butt" value="submit" alt="submit Button" src="resources/images/delete.png">
          ...
          <h1 style="font-size: 25px; text-align:center;"><c:out value="${preview1}"></c:out> <br></h1> 
         ...
         Моб.Телефон: &nbsp;&nbsp;<c:out value="${phone1}"></c:out> <br>
          ...
          <div class = "tablic" >
   <c:set var = "deleter" scope = "session" value = "${delete2}"/>
      <c:if test = "${deleter>0}">
         
          
          <form action="delete">
           <input type="hidden" name="id" value="<c:out value="${id2}"></c:out>">
           <input style="float: right; margin-top:10px; margin-right:10px;" width="20px" height="20px"type="image" name="butt" value="submit" alt="submit Button" src="resources/images/delete.png">
          ...
          <h1 style="font-size: 25px; text-align:center;"><c:out value="${preview2}"></c:out> <br></h1> 
        ...
        <div class = "tablic" >
   <c:set var = "deleter" scope = "session" value = "${delete3}"/>
      <c:if test = "${deleter>0}">
         
          
          <form action="delete">
           <input type="hidden" name="id" value="<c:out value="${id3}"></c:out>">
           <input style="float: right; margin-top:10px; margin-right:10px;" width="20px" height="20px"type="image" name="butt" value="submit" alt="submit Button" src="resources/images/delete.png">
        ...
        <h1 style="font-size: 25px; text-align:center;"><c:out value="${preview3}"></c:out> <br></h1> 
