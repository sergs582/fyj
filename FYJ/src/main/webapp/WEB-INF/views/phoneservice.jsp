...
<title>Ремонт электроники||FindYourJob.by</title>
</head>
<body>
 ...
 <div class= "welcome">
         ...
         <div class= "layer">
    <h1 style="text-align:center; color: #b9f747">Ремонт электроники</h1>
          <div class = "tablic" >
